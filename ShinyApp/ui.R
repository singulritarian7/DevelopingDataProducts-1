...
shinyUI(
    navbarPage("Shiny Application",
               ...
               tabPanel("Go back to my Github repository",
                        a("https://github.com/smeah25/DevelopingDataProducts"),
                        hr(),
                        h4("I hope you like the Shiny App"),
                        h4("The name of the repository is DevelopingDataProducts. All of my projects and assignments for this course are ther.")
               )
    )
)